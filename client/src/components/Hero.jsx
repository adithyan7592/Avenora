      ...
      <div className="relative min-h-[560px] lg:min-h-[680px]">
        ...
        <div className="relative z-10 mx-auto grid max-w-[1280px] items-center px-4 py-10 sm:px-5 sm:py-16 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-12">
          <div className="max-w-xl pb-8 sm:pb-28 lg:pb-20">
            <p className="gold-kicker">Guiding Careers. Building Futures. —</p>
            <p className="mt-3 font-script text-[28px] leading-[1.2] text-gold sm:text-[34px]">
              Your Career. Our Connections. Your Opportunity.
            </p>
            <h1 className="mt-4 font-serif text-[32px] font-medium leading-[1.18] sm:text-[48px] lg:text-[54px]">
              The Right Guidance Today, A Better Tomorrow.
            </h1>
            <p className="mt-4 text-[13px] font-medium leading-relaxed text-gold sm:mt-5 sm:text-[14px]">
          ...
          <div className="relative hidden min-h-[420px] lg:block">
            <div className="absolute right-0 top-8 z-20 flex w-[176px] flex-col gap-3">
              {pills.map(({ icon: Icon, label }) => (
                <div
                  key={label}
                  className="flex items-center gap-2 rounded-md bg-white/95 px-3 py-2.5 shadow-lg"
                >
